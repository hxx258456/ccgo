...
import (
	...
	v3statusgrpc "github.com/hxx258456/ccgo/go-control-plane/envoy/service/status/v3"
	grpc "github.com/hxx258456/ccgo/grpc"
	internaladmin "github.com/hxx258456/ccgo/grpc/internal/admin"
	"github.com/hxx258456/ccgo/grpc/resolver"
	"github.com/hxx258456/ccgo/grpc/xds/csds"

	_ "github.com/hxx258456/ccgo/grpc/credentials/tls/certprovider/pemfile"         // Register the file watcher certificate provider plugin.
	_ "github.com/hxx258456/ccgo/grpc/xds/internal/balancer"                        // Register the balancers.
	_ "github.com/hxx258456/ccgo/grpc/xds/internal/httpfilter/fault"                // Register the fault injection filter.
	_ "github.com/hxx258456/ccgo/grpc/xds/internal/httpfilter/rbac"                 // Register the RBAC filter.
	_ "github.com/hxx258456/ccgo/grpc/xds/internal/httpfilter/router"               // Register the router filter.
	xdsresolver "github.com/hxx258456/ccgo/grpc/xds/internal/resolver"              // Register the xds_resolver.
	_ "github.com/hxx258456/ccgo/grpc/xds/internal/xdsclient/controller/version/v2" // Register the v2 xDS API client.
	_ "github.com/hxx258456/ccgo/grpc/xds/internal/xdsclient/controller/version/v3" // Register the v3 xDS API client.
)
