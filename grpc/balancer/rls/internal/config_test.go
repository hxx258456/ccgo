...
import (
	...
	_ "github.com/hxx258456/ccgo/grpc/balancer/grpclb"               // grpclb for config parsing.
	_ "github.com/hxx258456/ccgo/grpc/internal/resolver/passthrough" // passthrough resolver.
)
