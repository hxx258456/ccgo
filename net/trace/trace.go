...
*/
package trace // import "github.com/hxx258456/ccgo/net/trace"
...
import (
	...
	"github.com/hxx258456/ccgo/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/hxx258456/ccgo/net/trace in your binary, trying to maintain separate state. This may " +
...
var contextKey = contextKeyT("github.com/hxx258456/ccgo/net/trace.Trace")
