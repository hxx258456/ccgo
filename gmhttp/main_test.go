...
func goroutineLeaked() bool {
	...
	fmt.Fprintf(os.Stderr, "Too many goroutines running after github.com/hxx258456/ccgo/gmhttp test(s).\n")
...
func afterTest(t testing.TB) {
	...
	badSubstring := map[string]string{
		...
		"created by github.com/hxx258456/ccgo/gmhttp/httptest.(*Server).Start": "an httptest.Server",
