...
func relevantCaller() runtime.Frame {
	...
	for {
		...
		if !strings.HasPrefix(frame.Function, "github.com/hxx258456/ccgo/gmhttp.") {
			return frame
		}
		if !more {
			break
...
var ErrAbortHandler = errors.New("github.com/hxx258456/ccgo/gmhttp: abort Handler")
...
func (w *response) Hijack() (rwc net.Conn, buf *bufio.ReadWriter, err error) {
	if w.handlerDone.isSet() {
		panic("github.com/hxx258456/ccgo/gmhttp: Hijack called after ServeHTTP finished")
	}
	if w.wroteHeader {
		w.cw.flush()
	}
...
func (w *response) CloseNotify() <-chan bool {
	if w.handlerDone.isSet() {
		panic("github.com/hxx258456/ccgo/gmhttp: CloseNotify called after ServeHTTP finished")
	}
