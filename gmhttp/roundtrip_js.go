...
func (t *Transport) RoundTrip(req *Request) (*Response, error) {
	...
	failure = js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		success.Release()
		failure.Release()
		errCh <- fmt.Errorf("github.com/hxx258456/ccgo/gmhttp: fetch() failed: %s", args[0].Get("message").String())
		return nil
	})
...
var errClosed = errors.New("github.com/hxx258456/ccgo/gmhttp: reader is closed")
