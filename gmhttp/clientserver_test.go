...
func testWriteHeaderAfterWrite(t *testing.T, h2, hijack bool) {
	...
	wantLog := "http: superfluous response.WriteHeader call from github.com/hxx258456/ccgo/gmhttp_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	// wantLog := "http: superfluous response.WriteHeader call from github.com/hxx258456/ccgo/"
	if hijack {
		wantLog = "http: response.WriteHeader on hijacked connection from github.com/hxx258456/ccgo/gmhttp_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
		// wantLog = "http: response.WriteHeader on hijacked connection from github.com/hxx258456/ccgo/"
	}
