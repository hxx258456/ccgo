...
import (
	...
	"github.com/hxx258456/ccgo/gmhttp/internal/testcert"
	tls "github.com/hxx258456/ccgo/gmtls"
	"github.com/hxx258456/ccgo/internal/nettrace"
...
func TestTransportCancelRequestInDial(t *testing.T) {
	...
	want := `dial: blocking
canceling
Get = Get "http://something.no-network.tld/": github.com/hxx258456/ccgo/gmhttp: request canceled while waiting for connection
`
	if got != want {
		t.Errorf("Got events:\n%s\nWant:\n%s", got, want)
	}
